...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 277.5, 41.0, 20.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 480.0, 70.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 500.0, 84.0, 20.0 ],
					"text" : "Delay :"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 514.0, 520.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 545.0, 54.0, 18.0 ],
					"text" : "delay $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 577.5, 52.0, 20.0 ],
					"text" : "s arman"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 300.0, 43.0, 20.0 ],
					"text" : "+~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.375, 240.0, 70.0, 20.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 242.0, 79.0, 20.0 ],
					"text" : "loadmess 3.7"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 435.375, 270.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.375, 242.0, 79.0, 20.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 353.0, 270.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 255.0, 53.0, 20.0 ],
					"text" : "cycle~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.375, 270.0, 56.0, 20.0 ],
					"sig" : 5.918
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 480.0, 70.0, 20.0 ],
					"text" : "loadmess 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 480.0, 101.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.0, 500.0, 84.0, 20.0 ],
					"text" : "Window Size :"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 399.0, 520.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 545.0, 47.0, 18.0 ],
					"text" : "size $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.0, 577.5, 52.0, 20.0 ],
					"text" : "s arman"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 500.0, 79.0, 20.0 ],
					"text" : "Voices Used :"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 288.0, 520.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 545.0, 59.0, 18.0 ],
					"text" : "voices $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 577.5, 52.0, 20.0 ],
					"text" : "s arman"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.0, 490.0, 327.0, 87.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 530.0, 195.0, 33.0 ],
					"text" : "args : Initials transpostions \n          (0.01 = cents)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 509.0, 150.0, 20.0 ],
					"text" : "arg 1 : Number of voices"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 500.0, 201.0, 67.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 277.5, 50.0, 20.0 ],
					"text" : "r arman"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 486.0, 167.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.375, 127.5, 150.0, 20.0 ],
...
,
					"patching_rect" : [ 460.0, 147.5, 97.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"setfilter" : [ 0, 3, 0, 0, 0, 3452.272705, 1.0, 25.0, 0.0001, 22050.0, 0.0001, 16.0, 0.5, 25.0 ]
												}
...
,
									"patching_rect" : [ 285.0, 135.0, 240.0, 120.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 105.0, 0.0, 240.0, 120.0 ],
									"varname" : "noiso"
								}
...
,
									"patching_rect" : [ 188.0, 15.0, 240.0, 120.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 105.0, 0.0, 240.0, 120.0 ],
									"varname" : "Soundofile"
								}
...
,
					"patching_rect" : [ 70.0, 120.0, 345.0, 122.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 120.0, 179.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 14.5, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 405.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 60.0, 457.0, 33.0 ],
					"text" : "pg.alechinsky~ uses delay lines and amplitude modulation to transpose the signal.\nhttp://fr.wikipedia.org/wiki/Arman.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 125.625, 330.0, 303.75, 20.0 ],
					"saved_object_attributes" : 					{
						"size" : 92.0
					}
,
					"text" : "pg.arman~ 4 0.5 1 3.7 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 5.0, 485.0, 30.0 ],
					"text" : "pg.arman~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 391.0, 71.0, 74.0 ]
				}
