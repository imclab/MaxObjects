...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 283.0, 98.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.5, 283.0, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 191.5, 180.5, 20.0 ],
					"text" : "arg 3 : Tukey window factor (0-1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 171.5, 165.5, 20.0 ],
					"text" : "arg 2 : Initial delay time (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 151.5, 150.0, 20.0 ],
					"text" : "arg 1 : Max delay time (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 142.5, 180.5, 79.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 175.5, 270.0, 57.0, 33.0 ],
					"text" : "Delay size :"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 270.0, 90.0, 33.0 ],
					"text" : "Tukey window factor :"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 306.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 175.5, 306.5, 64.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 277.5, 72.0, 20.0 ],
					"text" : "r alechinsky"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 303.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 391.375, 264.0, 150.0, 20.0 ],
...
,
					"patching_rect" : [ 407.0, 284.0, 97.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"setfilter" : [ 0, 1, 0, 0, 0, 3897.727295, 1.0, 0.520499, 0.0001, 22050.0, 0.0001, 16.0, 0.5, 25.0 ]
												}
...
,
					"patching_rect" : [ 90.0, 123.5, 345.0, 122.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 256.5, 179.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 405.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "pg.alechinsky~ uses delay lines and amplitude modulation to reverse the signal.\nhttp://en.wikipedia.org/wiki/Pierre_Alechinsky",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 90.0, 336.5, 190.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 391.0, 71.0, 74.0 ]
				}
