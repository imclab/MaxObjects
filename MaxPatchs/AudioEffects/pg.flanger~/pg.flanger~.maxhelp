...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 209.0, 300.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 256.0, 120.0, 34.0 ],
					"text" : "Delay size\n(signal, float or int)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 345.0, 153.0, 20.0 ],
					"text" : "pg.flanger~ 6000 2500"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "pg.flanger~.maxpat",
				"bootpath" : "\\Users\\Pierre\\Documents\\GitHub\\MaxObjects\\MaxPatchs\\AudioEffects\\pg.flanger~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
