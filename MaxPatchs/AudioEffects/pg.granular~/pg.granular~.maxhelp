...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 345.0, 285.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 300.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 135.0, 293.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 273.0, 108.0, 20.0 ],
					"text" : "loadmess set 2500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 259.0, 120.0, 34.0 ],
					"text" : "Delay size\n(signal, float or int)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 524.25, 357.0, 73.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 315.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 350.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 380.0, 59.0, 18.0 ],
					"text" : "voices $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 285.0, 60.0, 20.0 ],
					"text" : "r reverser"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 405.0, 62.0, 20.0 ],
					"text" : "s reverser"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 446.0, 335.0, 156.5, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 420.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 253.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 405.0, 75.0, 75.0 ]
				}
...
,
					"patching_rect" : [ 515.5, 273.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 75.0, 345.0, 279.0, 20.0 ],
					"text" : "pg.granular~ 12"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "A quasi-synchronous granular synthesizer.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 56.0, 597.0, 20.0 ],
					"text" : "pg.granular~ uses delay lines and amplitude modulations to create streams of grains.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.5, 240.0, 156.5, 60.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "pg.granular~.maxpat",
				"bootpath" : "\\Users\\Pierre\\Documents\\GitHub\\MaxObjects\\MaxPatchs\\AudioEffects\\pg.granular~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
