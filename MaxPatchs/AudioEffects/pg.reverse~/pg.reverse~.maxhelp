...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.0, 290.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 270.0, 108.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 256.0, 120.0, 34.0 ],
					"text" : "Delay size\n(signal, float or int)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.5, 367.0, 73.0, 48.0 ],
					"text" : "Set the maximum delay size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.5, 325.0, 108.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.5, 360.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.5, 390.0, 42.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.5, 415.0, 62.0, 20.0 ],
					"text" : "s reverser"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.5, 345.0, 156.5, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.5, 263.0, 150.0, 20.0 ],
...
,
					"patching_rect" : [ 333.0, 283.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 75.0, 345.0, 134.0, 20.0 ],
					"text" : "pg.reverse~ 6000 2500"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "pg.reverse~ uses delay lines and amplitude modulations to reverse the signal.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 250.0, 156.5, 60.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "pg.reverse~.maxpat",
				"bootpath" : "\\Users\\Pierre\\Documents\\GitHub\\MaxObjects\\MaxPatchs\\AudioEffects\\pg.reverse~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
